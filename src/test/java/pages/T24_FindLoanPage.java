...
public class T24_FindLoanPage extends CoreTapWrappers {
	
	private WebDriver driver;

	public T24_FindLoanPage(WebDriver driver) {
		this.driver = driver;
		this.test = test;
		PageFactory.initElements(this.driver, this);
		if (!verifyTitle("AA Arrangement - R18TJPLAY")) {
			reportStep("This is not a AA Arrangement - R18TJPLAY Page", "FAIL");
		}
		wait(2000);
	...
	@FindBy(how=How.XPATH, using="//label[text() ='Arrangement']/../../following-sibling::td[2]/input") WebElement searchwithArragnement;
	...
	@FindBy(how=How.XPATH, using = "//a[@title='Overview']") WebElement overview;
	...
	public void enter_SearchWithArrangement(String tempValue) {
		
		enterInputText(searchwithArragnement, tempValue, "Search With Arrangement");
	}
	...
	public void click_Overview() {
		webElementClick(overview, "Overview");
	}
	...
	public void enter_TranasactionId(String stempValue) {
		enterInputText(inputAADisbursementRef, stempValue, "Authorise Fund Transfer Id");
		String Temp=null;
	}
