...
public class T24_UnAuthorisedCustomerPage extends CoreTapWrappers {
	
	private WebDriver driver;

	public T24_UnAuthorisedCustomerPage(WebDriver driver) {
		this.driver = driver;
		this.test = test;
		PageFactory.initElements(this.driver, this);
		if (!verifyTitle("Unauthorised Customer - R18TJPLAY")) {
	...
	@FindBy(how=How.XPATH, using ="//input[@class='idbox idbox_CUSTOMER idbox_CUSTOMER_NAU']") WebElement trasactionId;
