...
public class T24_AuthorisedFundTransferPage extends CoreTapWrappers {
	
	private WebDriver driver;

	public T24_AuthorisedFundTransferPage(WebDriver driver) {
		this.driver = driver;
		this.test = test;
		PageFactory.initElements(this.driver, this);
		if (!verifyTitle("Unauthorised Funds Transfers (AA) - R18TJPLAY")) {
